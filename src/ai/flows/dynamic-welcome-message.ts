...
const prompt = ai.definePrompt({
  ...
  Based on the user's travel history, user preferences, and eco-sensitivity, create a personalized welcome message.
  The message should be concise (3-4 sentences) and have a friendly yet professional tone.
  Each sentence must not contain more than 18 words.
  Do not include a salutation or the user's name in your response.
